...
generative_test_demand = pd.DataFrame(x_test_jeju_solar)
generative_test_demand.to_csv("./RES/vae_generative_test_jeju_solar_01.csv", header=False, index=False)
generative_test_solar = pd.DataFrame(x_test_jeju_wind)
generative_test_solar.to_csv("./RES/vae_generative_test_jeju_wind_01.csv", header=False, index=False)
generative_test_solar = pd.DataFrame(x_test_land_wind)
generative_test_solar.to_csv("./RES/vae_generative_test_land_solar_01.csv", header=False, index=False)
generative_test_solar = pd.DataFrame(x_test_land_wind)
generative_test_solar.to_csv("./RES/vae_generative_test_land_wind_01.csv", header=False, index=False)
