...
df = pd.read_csv("./RES/vae_generative_test_land_wind_01.csv", header=None)
# print(df)
...
print(df_to)
df_to.to_csv("sampling/land_wind_rs42/sampling_land_wind_50.csv", header=None, index=False)