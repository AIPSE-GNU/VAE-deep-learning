...
df = pd.read_csv("./RES/vae_generative_test_land_solar_01.csv", header=None)
# print(df)
...
print(df_to)
df_to.to_csv("sampling/land_solar_rs42/sampling_land_solar_50.csv", header=None, index=False)