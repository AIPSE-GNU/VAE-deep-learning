...
df = pd.read_csv("./RES/vae_generative_test_jeju_solar_01.csv", header=None)
# print(df)
...
print(df_to)
df_to.to_csv("sampling/jeju_solar_rs42/sampling_jeju_solar_50.csv", header=None, index=False)